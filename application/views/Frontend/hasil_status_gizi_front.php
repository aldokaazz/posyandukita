...
<body data-spy="scroll" data-target=".fixed-top">
	...
	<div class="container grid px-6 mx-auto">
		...
		<br>
		<CENTER>
			<a class="btn-outline-reg" href="<?php echo base_url() . 'index.php/Frontend/cetak_hasil_pertumbuhan/' . $this->session->userdata('ses_id_ortu') . '' ?>">CETAK HASIL PERTUMBUHAN</a>
		</CENTER>
	</div>
	<br>
	<br>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="footer-col first">
						...
						<p class="p-small">Website ini digunakan untuk membantu pemerintah dalam hal kesehatan balita dan anak serta membantu orang tua untuk memantau tumbuh kembang anaknya tanpa harus datang ke posyandu
						</p>
					</div>
				</div> <!-- end of col -->
				<div class="col-md-4">
					<div class="footer-col middle">
						...
						<ul class="list-unstyled li-space-lg p-small">
							<li class="media">
								...
								<div class="media-body">Kami bekerja sama dengan pemerintah dan juga posyandu kita</a></div>
							</li>
							<li class="media">
								<i class="fas fa-square"></i>
					...
					<div class="footer-col last">
						...
						<ul class="list-unstyled li-space-lg p-small">
							...
							<li class="media">
								...
								<div class="media-body"><a class="white" href="mailto:posyandukita@pcr.ac.id">posyandukita@pcr.ac.id</a> <i class="fas fa-globe"></i><a class="white" href="#your-link">www.Tivo.com</a></div>
							</li>
						</ul>
					</div>
				</div> <!-- end of col -->
