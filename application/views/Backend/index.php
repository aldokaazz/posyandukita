          ...
          <ul>
            <li class="relative px-6 py-3">
              <a
                ...
                href="<?php echo base_url().'index.php/Backend/data_ortu' ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <!--<li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo base_url().'index.php/Backend/data_balita1' ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                ...
                <span class="ml-4">Data Balita1</span>
              </a>
            </li>-->
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?php echo base_url().'index.php/Backend/data_balita' ?>"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="<?php echo base_url().'index.php/Backend/data_pertumbuhan' ?>">Data Pertumbuhan</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
