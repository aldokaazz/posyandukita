...
<head>
	...
	<!-- Website Title -->
	<title>Profil Edit - PosyanduKita</title>
...
<body data-spy="scroll" data-target=".fixed-top">
					...
					<div class="col-lg-12">
						...
						<div class="form-row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="password" class="form-control" value="<?php echo $ortu->password ?>">
								</div>
							</div>
						</div>
						...
						<center>
							<div class="form-group mt-4 mb-0">
								<input type="submit" name="proses" class="btn btn-primary" value="Update Data Profil">
							</div>
						</center>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<p class="p-small">Copyright © 2020 by Kelompok3<br>
