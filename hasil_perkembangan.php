...
<head>
	...
	<!-- Website Title -->
	<title>Perkembangan - Posyandu Kita</title>
		...
		<div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<input name="usia" <?php foreach ($tbl_perkembangan_motorik as $perkembangan) {
										?> value="<?php echo $perkembangan->usia ?>" <?php } ?>>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
					...
					<div class="footer-col last">
						...
						<ul class="list-unstyled li-space-lg p-small">
							...
							<li class="media">
								...
								<div class="media-body"><a class="white" href="mailto:contact@Tivo.com">posyandukita@pcr.ac.id</a> <i class="fas fa-globe"></i><a class="white" href="#your-link">www.posyandukita.com</a></div>
							</li>
						</ul>
					</div>
				</div> <!-- end of col -->
