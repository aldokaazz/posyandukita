...
<head>
	...
	<!-- Website Title -->
	<title>Biodata - Posyandu Kita</title>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumbs">
						<a href="<?php echo base_url() . 'index.php/Frontend' ?>">Home</a><i class="fa fa-angle-double-right"></i><span>Biodata Balita</span>
		...
		<?php foreach ($tbl_balita as $balita) { ?>
			<div class="row">
				<div class="col-lg-12">
					...
					<a href="<?php echo base_url() . 'index.php/Frontend/biodata_edit/' . $balita->id_balita . '' ?>" class="btn btn-primary">Edit Biodata</a>
